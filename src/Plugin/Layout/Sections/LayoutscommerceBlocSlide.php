 ...
 *
 * @Layout(
 *   id = "clothingslayoutsbloc_slide",
 *   label = @Translation(" Commerce clothings section flash "),
 *   category = @Translation("layoutscommerce"),
 *   path = "layouts/sections",
 *   template = "layoutscommercebloc-slide",
 *   library = "layoutscommerce/layoutscommercebloc-slide",
 ...
 *     },
 *     "end_offre_date" = {
 *       "label" = @Translation("end_offre_date")
 *     },
 *   }
 * )
 */
class LayoutscommerceBlocSlide extends LayoutscommerceSection {
  /**
   *
   * @var string
   */
  protected $image_icon_url = '/icones/sections/clothingslayoutsbloc-slide.png';
