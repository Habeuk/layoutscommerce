 ...
 *
 * @Layout(
 *   id = "layoutscommerceclothing_single_banner",
 *   label = @Translation("  commerce clothing teaser banner "),
 *   category = @Translation("layoutscommerce"),
 *   path = "layouts/teasers",
 *   template = "layoutscommerceclothing-single-banner",
 *   library = "layoutscommerce/layoutscommerceclothing-single-banner",
 *   regions = {
 *   "categories" = {
...
class LayoutscommerceClothingSingle extends LayoutscommerceTeaser {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, StylesGroupManager $styles_group_manager) {
    ...
    $this->pluginDefinition->set('icon', $this->pathResolver->getPath('module', 'layoutscommerce') . "/icones/teasers/layoutscommerceclothing-single-banner.png");
